...
import com.founder.database.ScheduleJobMapper;
import com.founder.job.QuartzJobFactory;
import com.founder.job.QuartzJobFactoryDisallowConcurrentExecution;
...
public class JobTaskService {
	 ...
	 * @throws SchedulerException
	 */
	public void updateCron(Long jobId, String cron,String param) throws SchedulerException {
		ScheduleJob job = getTaskById(jobId);
		if (job == null) {
			return;
		}
	...
	public List<ScheduleJob> getAllJob() throws SchedulerException {
		...
		for (JobKey jobKey : jobKeys) {
			...
			for (Trigger trigger : triggers) {
				...
				log.debug("[triggerState="+triggerState.name()+"]");
